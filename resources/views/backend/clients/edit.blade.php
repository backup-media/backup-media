            ...
            <div class="nk-block nk-block-lg">
                <div class="card card-bordered">
                    <div class="card-inner">
                        <form action="{{ url('/update-client', $client->id)}}" class="form-validate" method="POST">
                            {{ csrf_field() }}
                            <div class="row g-gs">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="client_name" value="{{ $client->client_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" for="fv-email">information</label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control" id="fv-email" name="info" required>{{ $client->info_client}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
