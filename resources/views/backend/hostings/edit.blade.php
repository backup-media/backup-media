        ...
        <div class="components-preview wide-md mx-auto">
            <div class="nk-block-head nk-block-head-lg wide-sm">
                <div class="nk-block-head-content">
                    ...
                    <h2 class="nk-block-title fw-normal">Infomation Hosting</h2>
                </div>
            </div><!-- .nk-block-head -->
            <div class="nk-block nk-block-lg">
                <div class="card card-bordered">
                    <div class="card-inner">
                        <form action="{{ url('/update-hosting', $hosting->id)}}" class="form-validate" method="POST">
                            {{ csrf_field() }}
                            <div class="row g-gs">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fv-full-name" name="account_name_host" value="{{ $hosting->account_name_host}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap ">
                                            <select class="form-control form-select" id="fv-topics" name="id_client" data-placeholder="Select a option" required>
                                                ...
                                                <option name="id_client" value="{{ $client->id}}" {{ $hosting->id_client == $client->id ? 'selected':'' }}>{{ $client->client_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap ">
                                            <select class="form-control form-select" id="fv-topics" name="id_server" data-placeholder="Select a option" required>
                                                ...
                                                <option name="id_server" value="{{$server->id }}" {{ $hosting->id_server == $server->id ? 'selected':'' }}>{{ $server->company_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap ">
                                            <select class="form-control form-select" id="fv-topics" name="id_account" data-placeholder="Select a option" required>
                                                ...
                                                <option name="id_account" value="{{$account->id }}" {{ $hosting->id_account == $account->id ? 'selected':'' }}>{{ $account->username}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
